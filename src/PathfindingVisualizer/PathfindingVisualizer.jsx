...
export default class PathfindingVisualizer extends Component {
  ...
  render() {
    ...
    if (topMessage === "Creator : Rhea Sharma") {
      textBox = null;
      ...
      <div className="pathfindingVisualizer">
        <div className="container">
          <div className="heading">
            <h2 onClick={showPopUp}>Micro mouse</h2>
            <h2>{topMessage}</h2>
          </div>
          ...
          <p>
            Dijkstra's Algorithm is a weighted graph algorithm and guarantees the shortest path!{" "}
